...
public class ParameterServiceImpl implements ParameterService {
	...
	@Override
	public void updateObj(Parameter obj, String operator, Object id, Object... values){
		obj.setId((String)id);
		Parameter parameterTemp = parameterDao.findById((String)id);
		//系统参数持久对象构造
	...
	@Override
	public List<Parameter> getObjListPage(PageVO page, int queryType, Object... values) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Parameter getObj(Object id) {
		return parameterDao.findById((String)id);
	}

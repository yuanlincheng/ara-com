...
public class ManagerServiceImpl implements ManagerService {
	...
	public void saveObj(Manager obj, String operator, Object... values) throws ServiceException {
		//判别添加的管理员账号是否已存在   空串 标示增加
		if(!managerDao.checkExist(obj.getAccount(),"")){
	...
	@Override
	public void updateObj(Manager obj, String operator, Object id, Object... values) throws ServiceException {
		//判别修改的管理员账号是否已存在
		if(!managerDao.checkExist(obj.getAccount(),id)){
			...
			Manager managerTemp = managerDao.findById((String)id);
			//manager持久对象构造
			if(null != managerTemp){
			...
			throw new ServiceException("此管理员账号已被管理员删除!");
		}
	}

	@Override
	public List<Manager> getObjListPage(PageVO page, int queryType, Object... values) {
	...
	@Override
	public Manager getObj(Object id) {
		return managerDao.findById((String)id);
	}


	@Override
	public void delObj(Object id, Object... values) {

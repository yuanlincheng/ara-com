...
public class CodeServiceImpl  implements CodeService {
	...
	public void saveObj(Code obj, String operator, Object... values)
		...
		//判别添加的字典是否已存在   0 标示增加
		if(!codeDao.checkExist(0,obj.getCode(),obj.getType())){
	...
	@Override
	public void updateObj(Code obj, String operator, int id, Object... values)
			throws ServiceException {
		//判别添加的字典编号是否已存在
		if(!codeDao.checkExist(obj.getCode(),id)){
			obj.setId(id);
			Code codeTemp = codeDao.findById(id);
			//code持久对象构造
			if(null != codeTemp){
	...
	@Override
	public List<Code> getObjListPage(PageVO page, Object... values) {
